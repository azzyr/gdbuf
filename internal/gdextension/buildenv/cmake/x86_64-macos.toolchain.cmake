...
file(GLOB _cxx_candidates "${OSXCROSS_BIN}/x86_64-apple-darwin*-clang++")
if(NOT _cxx_candidates)
    message(FATAL_ERROR "Could not find x86_64-apple-darwin*-clang++ in ${OSXCROSS_BIN}.\n")
endif()
list(GET _cxx_candidates 0 _cxx)
get_filename_component(_cxx_name "${_cxx}" NAME)
string(REGEX REPLACE "-clang\\+\\+$" "" _triple "${_cxx_name}")

message(STATUS "OSXCross x86_64 triple: ${_triple}")
